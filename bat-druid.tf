...
/def gf=/set spell=gem_fire%;/set targettype=off%;/set spell_rounds=3%;/do_spell %{*} use gem%;@@remove tabard
...
/def si=/set spell=see_invisible%;/set targettype=prot%;/do_spell %{1}
