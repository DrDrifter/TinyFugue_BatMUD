...
/createprot -r1 -t2 -n"HP" -w"^[A-Z][a-z]+ .* \'sanctus \. o O\'" -u"^[A-z]+\'s [A-z \-]* (vibrates under magical pressure|flashes uncanny) as you are suddenly" -d"^(Holy particles slow down, rapidly fading away.)" -p"Heavenly prot"
