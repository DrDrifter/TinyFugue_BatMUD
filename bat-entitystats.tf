...
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} grasps " ma_att3=/set mahit3=$[mahit3+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} toe-kicks " ma_att4=/set mahit4=$[mahit4+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} knees " ma_att5=/set mahit5=$[mahit5+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} elbows " ma_att6=/set mahit6=$[mahit6+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} elbow-smashes " ma_att7=/set mahit7=$[mahit7+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} stomp-kicks " ma_att8=/set mahit8=$[mahit8+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} foot-steps " ma_att9=/set mahit9=$[mahit9+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} twists and throws " ma_att10=/set mahit10=$[mahit10+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} finger-jabs " ma_att11=/set mahit11=$[mahit11+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} joint-twists " ma_att12=/set mahit12=$[mahit12+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} back kicks " ma_att13=/set mahit13=$[mahit13+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} spinning back kicks " ma_att14=/set mahit14=$[mahit14+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} phoenix-eye punches " ma_att15=/set mahit15=$[mahit15+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} spinning backfists " ma_att16=/set mahit16=$[mahit16+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} jumps up and side-kicks " ma_att17=/set mahit17=$[mahit17+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} dragon-claws " ma_att18=/set mahit18=$[mahit18+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} feints high and then cruelly groin-rips " ma_att19=/set mahit19=$[mahit19+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} snake-strikes, blocking the chi of " ma_att20=/set mahit20=$[mahit20+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} pummels, with dozens of chain punches, " ma_att21=/set mahit21=$[mahit21+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} leaps, spins, and swallow-tail KICKS " ma_att22=/set mahit22=$[mahit22+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} DEVASTATES, with a thrusting blow, " ma_att23=/set mahit23=$[mahit23+1]
/eval /def -Fp5 -mregexp -i -t"^%{summoned_entity_name} BRUTALLY THROAT RIPS " ma_att24=/set mahit24=$[mahit24+1]
...
/eval /def -Fp1 -mglob -i -aBCblack -t"* successfully parries %{summoned_entity_name}'s bludgeon." ua_parries=/set hitpar=$[hitpar+1]
/eval /def -Fp1 -mglob -i -aBCblack -t"* successfully parries %{summoned_entity_name}'s attack." ma_parries=/set hitpar=$[hitpar+1]
/eval /def -aBCblack -i -t"%{summoned_entity_name} misses *" missi=/set miss=$[miss+1]
