...
;; Bashing hits
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} BARBARICALLY BASHES " cr_att26=/set crhit26=$$[crhit26+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} CRUELLY CUFFS " cr_att25=/set crhit25=$$[crhit25+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} BRUTALLY BEATS " cr_att24=/set crhit24=$$[crhit24+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} REALLY WHACKS " cr_att23=/set crhit23=$$[crhit23+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} savagely strikes " cr_att22=/set crhit22=$$[crhit22+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} savagely socks " cr_att21=/set crhit21=$$[crhit21+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} horribly thrusts " cr_att20=/set crhit20=$$[crhit20+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} badly smashes " cr_att19=/set crhit19=$$[crhit19+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} cruelly beats " cr_att18=/set crhit18=$$[crhit18+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} smashes " cr_att17=/set crhit17=$$[crhit17+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} beats " cr_att16=/set crhit16=$$[crhit16+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} whacks " cr_att15=/set crhit15=$$[crhit15+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} flails " cr_att14=/set crhit14=$$[crhit14+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} knocks " cr_att13=/set crhit13=$$[crhit13+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} cuffs " cr_att12=/set crhit12=$$[crhit12+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} socks " cr_att11=/set crhit11=$$[crhit11+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} strikes " cr_att10=/set crhit10=$$[crhit10+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} bashes " cr_att9=/set crhit9=$$[crhit9+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} jabs " cr_att8=/set crhit8=$$[crhit8+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} thrusts " cr_att7=/set crhit7=$$[crhit7+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} strokes " cr_att6=/set crhit6=$$[crhit6+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} thumps " cr_att5=/set crhit5=$$[crhit5+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} bumps " cr_att4=/set crhit4=$$[crhit4+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} butts " cr_att3=/set crhit3=$$[crhit3+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} jostles " cr_att2 =/set crhit2=$$[crhit2+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} lightly jostles " cr_att1 =/set crhit1=$$[crhit1+1]
;; Cutting hits (slash)
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} CRUELLY DISMEMBERS " sl_att26=/set slhit26=$$[slhit26+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} DISMEMBERS " sl_att25=/set slhit25=$$[slhit25+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} BARBARICALLY RENDS " sl_att24=/set slhit24=$$[slhit24+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} CRUELLY RENDS " sl_att23=/set slhit23=$$[slhit23+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} SAVAGELY SHREDS " sl_att22=/set slhit22=$$[slhit22+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} BRUTALLY TEARS " sl_att21=/set slhit21=$$[slhit21+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} savagely rips " sl_att20=/set slhit20=$$[slhit20+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} quickly cuts " sl_att19=/set slhit19=$$[slhit19+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} uncontrollably slashes " sl_att18=/set slhit18=$$[slhit18+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} cruelly slashes " sl_att17=/set slhit17=$$[slhit17+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} rives " sl_att16=/set slhit16=$$[slhit16+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} savagely shaves " sl_att15=/set slhit15=$$[slhit15+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} cruelly tatters " sl_att14=/set slhit14=$$[slhit14+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} slits " sl_att13=/set slhit13=$$[slhit13+1]
/eval /def -F -p99 -mregexp -i -t"^%{summoned_entity_name} incisively tears " sl_att12=/set slhit12=$$[slhit12+1]
