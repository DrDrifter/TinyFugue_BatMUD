...
;; Material hilites
/def -F -aB -mglob -t'*of {brass|cobalt|copper|electrum|iron|platinum|tungsten}*' lite_metals
/def -F -aB -mglob -t'*{brass|cobalt|copper|electrum|iron|platinum|tungsten} ore*' lite_metals_2
...
/def -F -aB -mglob -t'*glass*' lite_glass
/def -F -aB -mglob -t'*{ebony|mallorn}*' lite_trees

;; Secondary materials and other useful ones
/def -F -aB -aCyellow -mglob -t'*of {adamantium|anipium|batium|durandium|kryptonite|mithril|nullium|palladium|silicon|silver|starmetal|tadmium|titanium|zhentorium}*' lite_alloy_metals
/def -F -aB -aCyellow -mglob -t'*{adamantium|anipium|batium|durandium|kryptonite|mithril|nullium|palladium|silicon|silver|starmetal|tadmium|titanium|zhentorium} ore*' lite_alloy_metals_2
...
/def lj=/set skill=lumberjacking%;/set targettype=tree%;/if (axe_status =~ "unwielded") @wield axe%;/endif%;/do_skill %{*}
